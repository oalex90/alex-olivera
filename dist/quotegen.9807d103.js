...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../public/css/quotegen.scss":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"../public/js/quotegen.js":[function(require,module,exports) {
"use strict";

require("../css/quotegen.scss");
...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)("#new-quote").click(function () {
    //ger random quote
    var randQuote = getRandomQuote();
    var qte = randQuote.quote;
    var author = randQuote.author; //transition text

    (0, _jquery.default)("#text").fadeOut("slow", function () {
      (0, _jquery.default)("#text").html('"' + qte + '"').fadeIn("slow");
    });
    (0, _jquery.default)("#author").fadeOut("slow", function () {
      (0, _jquery.default)("#author").html("-" + author).fadeIn("slow");
    }); //update twitter link href

    (0, _jquery.default)("#tweet-quote").attr("href", 'https://twitter.com/intent/tweet?&text=' + encodeURIComponent('"' + qte + '"  -' + author)); //background color changes

    var newBackground = getNextBackground(curBackground);
    (0, _jquery.default)("body").css("background-color", newBackground);
    (0, _jquery.default)("#text").css("color", newBackground);
    (0, _jquery.default)("#author").css("color", newBackground);
    (0, _jquery.default)("#new-quote").css("background-color", newBackground);
    (0, _jquery.default)("#btn-tweet-quote").css("background-color", newBackground); //update curBackground var
...
var backgrounds = ["blueviolet", "crimson", "black", "darkblue", "darkgoldenrod", "grey", "brown", "deeppink", "forestgreen"];
...
var quotes = [];
quotes.push(new quote("Moral indignation is jealousy with a halo.", "H. G. Wells"));
...
},{"../css/quotegen.scss":"../public/css/quotegen.scss","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../public/js/quotegen.js"], null)
//# sourceMappingURL=/quotegen.9807d103.js.map