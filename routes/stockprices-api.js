...
module.exports = function (app, db) {
  ...
  const DB_TABLE = db.collection("stockLikes");
    ...
    if(typeof stock == 'object'){
        ...
        .then((response1)=>{
          ...
          rp(options2) //get price for stock2 after finished with stock1
            .then((response2)=>{
              ...
              DB_TABLE.findOne({stock: stock[0]}, (err, stock1Entry)=>{ //check if stock1 in db
                ...
                if(stock1Entry == null){
                  ...
                  if(like == 'true'){
                    ...
                    DB_TABLE.insertOne(newEntry1, (err, doc)=>{})
                  }
                }else{
                  ...
                  if(like == 'true' && !likes1.includes(userIp)){
                    ...
                    DB_TABLE.findOneAndUpdate(criteria, update, (er, res)=>{})
                  }
                }
                //second stock
                DB_TABLE.findOne({stock: stock[1]}, (err, stock2Entry)=>{
                  ...
                  if(stock2Entry == null){
                    ...
                    if(like == 'true'){
                      ...
                      DB_TABLE.insertOne(newEntry2, (err, doc)=>{})
                    }
                  }else{
      ...
      rp(options)
        .then((response)=>{
          ...
          DB_TABLE.findOne({stock: stock}, (err, entry)=>{
            ...
            if(entry == null){
              ...
              if(like == 'true'){
                ...
                DB_TABLE.insertOne(newEntry, (err, doc)=>{})
              }
            }else{
