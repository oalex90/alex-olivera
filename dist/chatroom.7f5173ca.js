...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../public/css/chatroom.scss":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-client/node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"../public/js/chatroom.js":[function(require,module,exports) {
"use strict";

require("../css/chatroom.scss");
...
(0, _jquery.default)(document).ready(function () {
  ...
  socket.on('user', function (data) {
    (0, _jquery.default)('#num-users').text(data.currentUsers + ' users online');
    ...
    (0, _jquery.default)('#messages').append((0, _jquery.default)('<li>').html('<b>' + message + '<\/b>'));
  });
  ...
  (0, _jquery.default)('form').submit(function () {
    var messageToSend = (0, _jquery.default)('#m').val(); //send message to server here?

    socket.emit('chat message', messageToSend);
    (0, _jquery.default)('#m').val('');
    return false; // prevent form submit from refreshing page
  });
});
},{"../css/chatroom.scss":"../public/css/chatroom.scss","jquery":"../node_modules/jquery/dist/jquery.js","socket.io-client":"../node_modules/socket.io-client/lib/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../public/js/chatroom.js"], null)
//# sourceMappingURL=/chatroom.7f5173ca.js.map